...
public class Main_gastos {
	...
	public static void main(String[] args) {
		...
		Contribuyente_simple contrS = new Contribuyente_simple("Juan", 123, ciudad1);
		Contribuyente_Factura contrC = new Contribuyente_Factura("Jose", 165, ciudad1, 10);
		Contribuyente_Factura contrP = new Contribuyente_Factura("Maria", 125, ciudad1, 50, 20, 2);
		
		ciudad1.agregarContribuyente(contrS);
		ciudad1.agregarContribuyente(contrC);
		ciudad1.agregarContribuyente(contrP);
		
		System.out.println(ciudad1.getContribuyentes());
		System.out.println("Monto recaudado en " + ciudad1.getNombre() + ": " + ciudad1.getMontoRecaudado());
		//-------------------------------------------------------------

		// GASTOS REALIZADOS - ANDA
		//System.out.println("Gastos realizados en " + ciudad1.getNombre());
		//System.out.println(ciudad1.getGastos());

		// CIUDADES EN DEFICIT - ANDA
		//System.out.println("Ciudades en deficit en " + prov1.getNombre());
		//System.out.println(prov1.getCiudadesEnDeficil());

		// PROVINCIAS CON MAS DE LA MITAD DE CIUDADES EN DEFICIT - ANDA
