...
public class Peluqueria {
	...
	public LocalDate getFechaLimite() {
		...
		LocalDate fechaLimite = LocalDate.of(hoy.getYear(), (hoy.getMonthValue() - this.cantMesesParaSerFrecuente),
				hoy.getDayOfMonth());
	...
	public boolean isClienteFrecuente(Cliente cliente) {
		...
		for (Turno t : this.turnos) {
			LocalDate fechaTurno = LocalDate.of(t.getInicioTurno().getYear(), t.getInicioTurno().getMonthValue(),
					t.getInicioTurno().getDayOfMonth());
